...
export const getUnit = asyncHandler(async (req, res) => sendSuccess(res, { message: 'Blood unit', data: await service.getUnit(req.params.id) }));
...
export const issueUnit = asyncHandler(async (req, res) => sendSuccess(res, { message: 'Unit issued', data: await service.issueUnit(req.params.id, req.body, req.user?._id) }));
export const reserveUnit = asyncHandler(async (req, res) => sendSuccess(res, { message: 'Unit reserved', data: await service.reserveUnit(req.params.id, req.body.patient, req.user?._id) }));
export const unreserveUnit = asyncHandler(async (req, res) => sendSuccess(res, { message: 'Reservation released', data: await service.unreserveUnit(req.params.id) }));
