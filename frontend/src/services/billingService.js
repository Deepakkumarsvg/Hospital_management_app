...
export const cancelInvoice = (id, reason) => api.patch(`/billing/invoices/${id}/cancel`, { reason }).then((r) => r.data.data);
export const refundInvoice = (id, p) => api.post(`/billing/invoices/${id}/refund`, p).then((r) => r.data.data);
